...
export const TestComponents: React.FC = () => (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
        ...
        <br />
        <br />
        <DefaultBrowserButton onClick={() => alert('Default browser button clicked!')}>
            Default Browser Button
        </DefaultBrowserButton>
        <br />
        <br />
        <GoodButtonWithShadow onClick={() => alert('Good button with shadow clicked!')}>
            Good Button with Shadow
        </GoodButtonWithShadow>
        <br />
        <br />
        ...
        <br />
        <br />
        <BadButtonWithShadow onClick={() => alert('Bad button with shadow clicked!')}>
            Bad Button with Shadow
        </BadButtonWithShadow>
        <br />
        <br />
        ...
        <br />
        <br />
        <BadCustomButton onClick={() => alert('Bad custom button clicked!')}>
            Bad Custom Button (role=&quot;button&quot;)
        </BadCustomButton>
        <br />
        <br />
        <BadInputButtonNoBorder
