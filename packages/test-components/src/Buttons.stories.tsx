...
export const DefaultBrowserButtonStory: Story = {
    render: () => (
        <DefaultBrowserButton onClick={() => alert('Default browser button!')}>
...
export const GoodButtonWithShadowStory: Story = {
    render: () => (
        <GoodButtonWithShadow onClick={() => alert('Good button with shadow!')}>
...
export const BadButtonWithShadowStory: Story = {
    render: () => (
        <BadButtonWithShadow onClick={() => alert('Bad button with shadow!')}>
